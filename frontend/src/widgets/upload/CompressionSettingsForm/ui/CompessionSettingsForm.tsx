...
export function CompressionSettingsForm({   title,
  setTitle,
  description,
  setDescription,
  format,
...
<div className="upload__content">
              ...
              <div className="form-group">
                ...
                <div className="upload__sizes" >
                 <div className="upload__sizes__text"> <p>Оригинальный размер:</p> <span> {originalSizeMB.toFixed(2)} MB</span></div>
                  <div className="upload__sizes__text"> <p>Примерный размер после сжатия:</p> <span>-{compressedSizeMB.toFixed(2)} MB</span></div>
                  <div className="upload__sizes__text"> <p>Вы экономите:</p><span> {savedPercent}%</span></div>
                </div>
              </form>
