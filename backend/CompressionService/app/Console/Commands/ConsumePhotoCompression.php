...
use App\Consumers\PhotoCompressionConsumer;
...
class ConsumePhotoCompression extends Command
{
    ...
    public function handle(
        ...
        CompressionRecommendationService $compressionRecommendationService
    ): void {
        ...
        $consumer = Kafka::consumer()
            ->subscribe($topic)
            ->withHandler(new PhotoCompressionConsumer(
                $compressionService,
                $compressionRecommendationService
            ))
